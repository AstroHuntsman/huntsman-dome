...
public:
	...
	//@{
	virtual void deviceInfoNameShort(BasicStringInterface& str) const					{(void)str;};
	virtual void deviceInfoNameLong(BasicStringInterface& str) const					{(void)str;};
	virtual void deviceInfoDetailedDescription(BasicStringInterface& str) const			{(void)str;};
	virtual void deviceInfoFirmwareVersion(BasicStringInterface& str)					{(void)str;};
	virtual void deviceInfoModel(BasicStringInterface& str)								{(void)str;};
	//@}
