...
PACKAGENAME = metadata.get('package_name', 'domehunter')
DESCRIPTION = metadata.get('description', 'Huntsman Telescope dome control')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: domehunter requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
